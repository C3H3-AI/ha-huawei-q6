...
async def _async_port_mapping_add(hass: HomeAssistant, service: ServiceCall):
    ...
    _LOGGER.debug(
        ...
        service.service, internal_host, internal_port, external_port, protocol,
    )
    ...
    try:
        ...
        _LOGGER.info("Port mapping added successfully: %s:%s -> %s:%s/%s",
                     internal_host, internal_port, external_port, protocol, description)
...
async def _async_port_mapping_remove(hass: HomeAssistant, service: ServiceCall):
    ...
    _LOGGER.debug(
        ...
        service.service, external_port, protocol,
    )
