...
def get_option(config_entry: ConfigEntry, name: str, default: Any | None = None) -> Any | None:
...
class HuaweiIntegrationOptions:
    ...
    def wifi_access_switches(self) -> bool:
        ...
        return get_option(self._config_entry, OPT_WIFI_ACCESS_SWITCHES, DEFAULT_WIFI_ACCESS_SWITCHES)
    ...
    def device_tracker(self) -> bool:
        ...
        return get_option(self._config_entry, OPT_DEVICE_TRACKER, DEFAULT_DEVICE_TRACKER)

    @property
    def device_tracker_zones(self) -> bool:
        """Return option 'device tracker zones' value"""
        return get_option(self._config_entry, OPT_DEVICE_TRACKER_ZONES, DEFAULT_DEVICE_TRACKER_ZONES)

    @property
    def url_filter_switches(self) -> bool:
        """Return option 'url filter switches' value"""
        return get_option(self._config_entry, OPT_URL_FILTER_SWITCHES, DEFAULT_URL_FILTER_SWITCHES)

    @property
    def port_mapping_switches(self) -> bool:
        """Return option 'port mapping switches' value"""
        return get_option(self._config_entry, OPT_PORT_MAPPING_SWITCHES, DEFAULT_PORT_MAPPING_SWITCHES)
    ...
    @property
    def skip_offline_devices(self) -> bool:
        """Return option 'skip offline devices' value"""
        return get_option(
            self._config_entry,
            OPT_SKIP_OFFLINE_DEVICES,
            DEFAULT_SKIP_OFFLINE_DEVICES,
