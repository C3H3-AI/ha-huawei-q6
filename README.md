...
## 支持的设备（不在清单没的自行测试，如果支持请告知）

| 型号 | 类型 | 支持状态 |
|------|------|----------|
| 华为 Q6/7 网线版电力版 | Mesh 主路由 | ✅ 已测试 |
| 华为 Q6/7 子路由 | Mesh 子路由 | ✅ 自动发现 |
| 华为 be3         |              | ✅ 已测试 |
| 华为 Q6 WiFi 版 | Mesh 主路由 | ⚠️ 理论兼容 |
| 华为 Q7 系列 | Mesh 主路由 | ✅ 社区用户测试通过 |
| 华为 BE3 系列 (WiFi 7) | Mesh 主路由 | ✅ 社区用户测试通过 |
| 华为 AX3 双核 (WS7100) | 主路由 | ✅ 上游项目已验证 |
| 华为 AX3 四核 (WS7200) | 主路由 | ✅ 上游项目已验证 |
| 华为 AX3 Pro (WS7206) | 主路由 | ✅ 上游项目已验证 |
| 华为 Mesh 3 (WS8100) / Mesh 7 (WS8800) | 主路由 | ✅ 上游项目已验证 |
| 荣耀路由 3 (XD20) | 主路由 | ✅ 上游项目已验证 |

> AX3 系列与 Q6/Q7/BE3 使用同一套鸿蒙局域网管理接口，本集成开箱即用，无需任何额外配置。
> **集成图标**：集成本地品牌图为 Home Assistant **2026.3+** 特性，旧版本 HA 中集成会显示默认图标，属正常现象。
